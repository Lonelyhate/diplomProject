...
public class ProductService : IProductService
{
    ...
    public async Task<ProductCreateResponseModel> CreateProduct(ProductCreateRequestModel requestModel)
    {
        try
        {
            ...
            var productCheck = _productRepository.GetByName(requestModel.Name);
            if (productCheck.Result is not null)
            {
    ...
    public async Task<ProductGetAllResponseModel> GetAllProducts()
    {
        try
        {
